...
class InputUserInfoScreen : BaseFragment<InputUserInfoScreenViewModel, ScreenInputUserInfoBinding>(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        withViewModel<InputUserInfoScreenViewModel> {
            observeEvent(localCountry) {
                ...
                Glide.with(requireContext()).load("$FLAG_BASE_URL/${it.code.lowercase()}.png").into(viewBind.imvFlag)
            }
    ...
    private fun showYearPickerDialog(){
        ...
        dialogViewBind.numberPickerYear.minValue = 1970
    ...
    private fun setCountry(country: Country){
        ...
        Glide.with(requireContext()).load("$FLAG_BASE_URL/${country.code.lowercase()}.png").into(viewBind.imvFlag)
    ...
    private fun showCountryListDialog(){
        val adapter = CountryListAdapter(BaseViewModel.accessoryData.countries.toMutableList())
